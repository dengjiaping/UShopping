 ...
 */
public class BrandFavouriteItemAdapter extends BaseAdapter {
    //填充数据的List
    ...
    //构造器
    public BrandFavouriteItemAdapter(List<Map<String,Object>> list,Activity context){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            convertView =inflater.inflate(R.layout.brand_favourite_item, null);
